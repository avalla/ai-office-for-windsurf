---
description: 30_plan_tasks (Multi-project, enterprise)
---
...
## OUTPUTS (must)
- Create/update `projects/<project>/.ai-agency/docs/runbooks/<slug>-tasks.md` using `.agents/templates/runbook-tasks.md`
