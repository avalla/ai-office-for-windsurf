---
description: 40_dev_implement (Multi-project)
---
...
2. **Move Tasks to WIP:**
   - **CRITICAL RULE:** Update task file BEFORE moving (see `.agents/rules/task-management.md`)
...
**Reference:** `.agents/rules/task-management.md`
