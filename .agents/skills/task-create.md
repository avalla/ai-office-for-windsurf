...
## GOAL
Create new tasks with proper formatting, metadata, and placement in the correct Kanban folder.
...
## OUTPUTS
- Task file created in `tasks/TODO/`
...
- Verify `.ai-agency/tasks/TODO/` folder exists
...
- Use template below
- Place in `tasks/TODO/` folder

### 4. Update README.md
- Increment TODO count in `tasks/README.md`
...
## INTEGRATION
- Used by workflows: 30_plan_tasks, 40_dev_implement
