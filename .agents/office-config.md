...
- Canonical matrix: `.agents/software-mcp-proposals.md`
...
> **Pre-configured agency templates available in `.agents/agencies/` folder.**
...
> **Detailed agent profiles available in `.agents/agents/` folder.**
...
- **Patterns:** `.agents/skills/`, `memory/patterns/`
